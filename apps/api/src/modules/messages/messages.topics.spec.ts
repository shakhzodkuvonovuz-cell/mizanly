...
import { mockRedis, mockConfigService, mockNotificationsService, mockContentSafetyService } from '../../common/test/mock-providers';
...
describe('MessagesService — Group Topics & Message Expiry', () => {
  ...
  beforeEach(async () => {
    const module = await Test.createTestingModule({
      providers: [MessagesService, mockPrisma, mockRedis, mockConfigService, mockPush, mockAi, mockNotificationsService, mockContentSafetyService],
    }).compile();
