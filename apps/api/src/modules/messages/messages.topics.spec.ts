...
import { mockRedis, mockConfigService, mockEventEmitter, mockContentSafetyService } from '../../common/test/mock-providers';
...
describe('MessagesService — Group Topics & Message Expiry', () => {
  ...
  beforeEach(async () => {
    const module = await Test.createTestingModule({
      providers: [MessagesService, mockPrisma, mockRedis, mockConfigService, mockPush, mockAi, mockEventEmitter, mockContentSafetyService],
    }).compile();
