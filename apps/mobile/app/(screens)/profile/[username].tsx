...
const createStyles = (tc: ReturnType<typeof useThemeColors>) => StyleSheet.create({
  ...
  pinnedScroll: { paddingStart: spacing.base },
  pinnedItem: {
    width: 140, height: 180, borderRadius: radius.md,
    backgroundColor: tc.bgElevated, marginEnd: spacing.sm,
    overflow: 'hidden',
  },
  ...
  carouselBadge: { position: 'absolute', top: 8, end: 8 },
  reelOverlay: {
  ...
  reelStats: {
    position: 'absolute', bottom: 8, end: 8,
    flexDirection: 'row', alignItems: 'center', gap: 4,
  },
