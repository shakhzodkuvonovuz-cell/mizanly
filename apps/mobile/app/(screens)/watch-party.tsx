...
const createStyles = (tc: ReturnType<typeof useThemeColors>) => StyleSheet.create({
  ...
  selectedVideoTitle: { color: tc.text.primary, fontSize: fontSize.base, fontWeight: '500' },
  ...
  videoPickerTitle: { color: tc.text.primary, fontSize: fontSize.base, fontWeight: '500' },
